...
namespace LearnerAPI.Controllers
{
    ...
    public class LearnerController : ControllerBase
    {
        ...
        {
           return await GetRecords(partitionKey);
        }
        ...
        {
            await AddItemsToContainerAsync(newFamily);
        }
        ...
        {
            await ReplaceFamilyItemAsync(newFamily, partitionKeyValue);
        }
        ...
        {
            await DeleteFamilyItemAsync(partitionKeyValue, familyId);
        }
        ...
        /// Add Family items to the container
        /// </summary>
        private async Task AddItemsToContainerAsync(Family andersenFamily)
        {
            ItemResponse<Family> andersenFamilyResponse = await this.container.CreateItemAsync<Family>(andersenFamily, new PartitionKey(andersenFamily.PartitionKey));
        }
        // </AddItemsToContainerAsync>
        ...
        /// </summary>
        private async Task DeleteFamilyItemAsync(string partitionKeyValue, string familyId)
        {
        ...
        private async Task<IEnumerable<Family>> GetAllRecords()
        {
        ...
        private async Task<IEnumerable<Family>> GetRecords(string partitionKey)
        {
        ...
        /// </summary>
        private async Task ReplaceFamilyItemAsync(Family newFamily, string partitionKey)
        {
            ItemResponse<Family> wakefieldFamilyResponse = await this.container.ReadItemAsync<Family>(newFamily.Id, new PartitionKey(partitionKey));
